...
const Settings: React.FC = () => {
  ...
  const customHeader = (
    ...
    <div className="flex align-items-center gap-2">
      ...
      <p className="text-xl font-bold text-[#0a5c9c]">{t("dashboard.car_management")}</p>
    </div>
  );
  useEffect(() => {
    ...
    if (visibleSidebar) {
      ...
      body.style.touchAction = "none";  // disable touch scroll on mobile
    } else {
      body.style.overflow = "auto";     // enable scroll when closed
    ...
    <>
      <div>
        <div className="text-2xl font-semibold p-3">
          <div className={visibleSidebar ? "sidebar-bg-freeze" : ""}>
